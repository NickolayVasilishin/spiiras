...
public class PacketStatsWritable extends org.apache.hadoop.record.Record {
    @Override
    public void serialize(RecordOutput recordOutput, String s) throws IOException {
...
//                src_ip = _rio_a.readString("src_ip");
//            } else if (2 == _rio_rtiFilterFields[_rio_i]) {
//                dst_ip = _rio_a.readString("dst_ip");
//            } else if (3 == _rio_rtiFilterFields[_rio_i]) {
//                src_port = _rio_a.readInt("src_port");
//            } else if (4 == _rio_rtiFilterFields[_rio_i]) {
//                dst_port = _rio_a.readInt("dst_port");
//            } else if (5 == _rio_rtiFilterFields[_rio_i]) {
//                packets = _rio_a.readLong("packets");
//            } else if (6 == _rio_rtiFilterFields[_rio_i]) {
//                app_type = _rio_a.readInt("app_type");
//            } else if (7 == _rio_rtiFilterFields[_rio_i]) {
//                ack = _rio_a.readInt("ack");
//            } else if (8 == _rio_rtiFilterFields[_rio_i]) {
//                rst = _rio_a.readInt("rst");
//            } else if (9 == _rio_rtiFilterFields[_rio_i]) {
//                pure_ack = _rio_a.readInt("pure_ack");
//            } else if (10 == _rio_rtiFilterFields[_rio_i]) {
//                unique_bytes = _rio_a.readLong("unique_bytes");
//            } else if (11 == _rio_rtiFilterFields[_rio_i]) {
//                data_pkts = _rio_a.readLong("data_pkts");
//            } else if (12 == _rio_rtiFilterFields[_rio_i]) {
//                data_bytes = _rio_a.readLong("data_bytes");
//            } else if (13 == _rio_rtiFilterFields[_rio_i]) {
//                rexmit_pkts = _rio_a.readInt("rexmit_pkts");
//            } else if (14 == _rio_rtiFilterFields[_rio_i]) {
//                rexmit_bytes = _rio_a.readInt("rexmit_bytes");
//            } else if (15 == _rio_rtiFilterFields[_rio_i]) {
//                out_seq_pkts = _rio_a.readInt("out_seq_pkts");
//            } else if (16 == _rio_rtiFilterFields[_rio_i]) {
//                syn = _rio_a.readInt("syn");
//            } else if (17 == _rio_rtiFilterFields[_rio_i]) {
//                fin = _rio_a.readInt("fin");
//            } else if (18 == _rio_rtiFilterFields[_rio_i]) {
//                ws = _rio_a.readBool("ws");
//            } else if (19 == _rio_rtiFilterFields[_rio_i]) {
//                ts = _rio_a.readBool("ts");
//            } else if (20 == _rio_rtiFilterFields[_rio_i]) {
//                win_scale = _rio_a.readInt("win_scale");
//            } else if (21 == _rio_rtiFilterFields[_rio_i]) {
//                sack_req = _rio_a.readBool("sack_req");
//            } else if (22 == _rio_rtiFilterFields[_rio_i]) {
//                sack_sent = _rio_a.readInt("sack_sent");
//            } else if (23 == _rio_rtiFilterFields[_rio_i]) {
//                mss = _rio_a.readInt("mss");
//            } else if (24 == _rio_rtiFilterFields[_rio_i]) {
//                seq_max = _rio_a.readLong("seq_max");
//            } else if (25 == _rio_rtiFilterFields[_rio_i]) {
//                seq_min = _rio_a.readLong("seq_min");
//            } else if (26 == _rio_rtiFilterFields[_rio_i]) {
//                win_max = _rio_a.readInt("win_max");
//            } else if (27 == _rio_rtiFilterFields[_rio_i]) {
//                win_min = _rio_a.readInt("win_min");
//            } else if (28 == _rio_rtiFilterFields[_rio_i]) {
//                cnt_zerowin = _rio_a.readInt("cnt_zerowin");
//            } else if (29 == _rio_rtiFilterFields[_rio_i]) {
//                cwin_max = _rio_a.readInt("cwin_max");
//            } else if (30 == _rio_rtiFilterFields[_rio_i]) {
//                cwin_min = _rio_a.readInt("cwin_min");
//            } else if (31 == _rio_rtiFilterFields[_rio_i]) {
//                initial_cwin = _rio_a.readInt("initial_cwin");
//            } else if (32 == _rio_rtiFilterFields[_rio_i]) {
//                tot_rtt = _rio_a.readLong("tot_rtt");
//            } else if (33 == _rio_rtiFilterFields[_rio_i]) {
//                rtt_min = _rio_a.readLong("rtt_min");
//            } else if (34 == _rio_rtiFilterFields[_rio_i]) {
//                rtt_max = _rio_a.readLong("rtt_max");
//            } else if (35 == _rio_rtiFilterFields[_rio_i]) {
//                ttl = _rio_a.readInt("ttl");
//            } else if (36 == _rio_rtiFilterFields[_rio_i]) {
//                ttl_max = _rio_a.readInt("ttl_max");
//            } else if (37 == _rio_rtiFilterFields[_rio_i]) {
//                ttl_min = _rio_a.readInt("ttl_min");
//            } else if (38 == _rio_rtiFilterFields[_rio_i]) {
//                timeout = _rio_a.readInt("timeout");
//            } else if (39 == _rio_rtiFilterFields[_rio_i]) {
//                dup3ack = _rio_a.readInt("dup3ack");
//            } else if (40 == _rio_rtiFilterFields[_rio_i]) {
//                reordering = _rio_a.readInt("reordering");
//            } else if (41 == _rio_rtiFilterFields[_rio_i]) {
//                net_dup = _rio_a.readInt("net_dup");
//            } else if (42 == _rio_rtiFilterFields[_rio_i]) {
//                unknown = _rio_a.readInt("unknown");
//            } else if (43 == _rio_rtiFilterFields[_rio_i]) {
//                first_time = _rio_a.readLong("first_time");
//            } else if (44 == _rio_rtiFilterFields[_rio_i]) {
//                last_time = _rio_a.readLong("last_time");
//            } else if (45 == _rio_rtiFilterFields[_rio_i]) {
//                direction = _rio_a.readInt("direction");
//            } else if (46 == _rio_rtiFilterFields[_rio_i]) {
//                acknum = _rio_a.readLong("acknum");
//            } else if (47 == _rio_rtiFilterFields[_rio_i]) {
//                tcp = _rio_a.readBool("tcp");
//            } else if (48 == _rio_rtiFilterFields[_rio_i]) {
//                rtt_cnt = _rio_a.readInt("rtt_cnt");
//            } else if (49 == _rio_rtiFilterFields[_rio_i]) {
//                payload = _rio_a.readBuffer("payload");
//            } else if (50 == _rio_rtiFilterFields[_rio_i]) {
//                http_type = _rio_a.readInt("http_type");
//            } else if (51 == _rio_rtiFilterFields[_rio_i]) {
//                firstkey = _rio_a.readBuffer("firstkey");
//            } else if (52 == _rio_rtiFilterFields[_rio_i]) {
//                secondkey = _rio_a.readBuffer("secondkey");
//            } else if (53 == _rio_rtiFilterFields[_rio_i]) {
//                iscomplete = _rio_a.readBool("iscomplete");
//            } else {
